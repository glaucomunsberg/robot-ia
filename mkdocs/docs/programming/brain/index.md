The brain is **[STRUCTURED](structure.md)** by **[CORTEX](cortex.md)** that run all **[IDEIAS](../ideas/index.md)** with your **[COMMANDS](../commands/index.md)**. All data to send/used in each idea use the **[PROTOCOL](../protocols/index.md)**. 
